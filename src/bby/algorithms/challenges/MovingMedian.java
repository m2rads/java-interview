...
public class MovingMedian {
    ...
    /**
        ...
        a sliding window size, N, as the first element in the array and the rest will be a list of numbers.
        ...
        to each entry in the original array separated by commas. Note that for the first few elements (until the
        window size is reached), the median is computed on a smaller number of entries. For example: if arr is
        [3, 1, 3, 5, 10, 6, 4, 3, 1] then your program should output "1,2,3,5,6,6,4,3".
    */
